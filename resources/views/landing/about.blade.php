...
<div class="nd-page-hero" data-aos="fade-in">
    <div class="nd-page-hero-bg" style="background-image:url('{{ landing_asset('landing/images/005c7ff0-5885-426a-9a03-f846973c7987.JPG') }}');"></div>
        ...
        <div class="nd-two-col" style="position:relative;">
            ...
            <div data-aos="fade-left" data-aos-delay="150">
                <div class="nd-img-card">
                    <img src="{{ landing_asset('landing/images/005c7ff0-5885-426a-9a03-f846973c7987.JPG') }}" alt="NEORA Clinic interior"/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="nd-two-col" style="position:relative;">
            ...
            <div data-aos="fade-right">
                <div class="nd-director-card">
                    <img src="{{ landing_asset('landing/Director/Director.png') }}" alt="BASLP Priyanka Rawat, Director &amp; Lead Therapist"/>
