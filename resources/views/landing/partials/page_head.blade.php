 ...
 */
$pageTitle = isset($pageTitle) ? $pageTitle : 'NEORA Speech Therapy & Audiology Clinic';
if (empty($pageTitleIsFull) && $pageTitle !== 'NEORA Speech Therapy & Audiology Clinic') {
    $pageTitle = $pageTitle . ' – NEORA Speech Therapy & Audiology Clinic';
}
...
<head>
    ...
    <!-- NEORA design system -->
    <link rel="stylesheet" href="<?php echo $baseUrl; ?>assets/css/neora-redesign.css">
