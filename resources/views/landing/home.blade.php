...
<div class="nd-two-col" style="position:relative;">
    ...
    <div data-aos="fade-right">
        ...
        <a href="{{ route('contact') }}#book" class="nd-btn nd-btn-orange">
            Book a Consultation
    ...
    <div data-aos="fade-left" data-aos-delay="150">
        <div class="nd-img-card">
            <img
                src="{{ landing_asset('landing/images/005c7ff0-5885-426a-9a03-f846973c7987.webp') }}"
                alt="NEORA Clinic interior"
                onerror="this.src='{{ landing_asset('landing/sliders/2.JPG') }}'"
            />
        </div>
    </div>
</div>
...
@endphp
@include('landing.partials.section')
...
<div class="nd-two-col" style="position:relative;">
    ...
    <div data-aos="fade-right">
        <div class="nd-director-card">
            <img
                src="{{ landing_asset('landing/Director/Director.webp') }}"
...
<div class="nd-cards-grid" style="margin-bottom:40px;">
    <?php
    $galleryImages = [
        landing_asset('landing/images/5bfe9bd1-6666-4281-8420-072ba3d40132.webp'),
        landing_asset('landing/images/005c7ff0-5885-426a-9a03-f846973c7987.webp'),
        landing_asset('landing/images/46d06ad3-baa1-4ea7-bdcb-37cff039943c.webp'),
        landing_asset('landing/images/79ab4111-df96-4bd8-806d-929e963fc0b2.webp'),
    ];
...
<div style="text-align:center;" data-aos="fade-up" data-aos-delay="320">
    <a href="<?php echo htmlspecialchars(route('gallery')); ?>" class="nd-btn nd-btn-orange">
        Explore More
        <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
        </svg>
...
<div style="text-align:center;margin-top:40px;" data-aos="fade-up" data-aos-delay="200">
    <a href="{{ route('contact') }}#book" class="nd-btn nd-btn-orange">Book a Session Today</a>
</div>
@php
$section_content = ob_get_clean();
@endphp
...
<div style="text-align:center;margin-top:40px;" data-aos="fade-up" data-aos-delay="400">
    <a href="{{ route('contact') }}#book" class="nd-btn nd-btn-orange">Learn More About Sessions</a>
</div>
@php
$section_content = ob_get_clean();
@endphp
...
<div style="text-align:center;margin-top:32px;" data-aos="fade-up" data-aos-delay="300">
    <a href="<?php echo htmlspecialchars(route('reviews')); ?>" class="nd-btn nd-btn-orange">
        View All Reviews
...
window.ndMobileBooking = function () {
    ...
    fetch('{{ route('api.book-session') }}', { method: 'POST', body: fd })
