...
<div class="nd-page-hero" data-aos="fade-in">
    <div class="nd-page-hero-bg" style="background-image:url('{{ landing_asset('landing/images/d3263e16-976f-4a9f-8842-a2e3b75dadf3.JPG') }}');"></div>
...
<div class="nd-success-backdrop" id="ndSuccessBackdrop">
    <div class="nd-success-modal" role="dialog" aria-modal="true" aria-labelledby="successTitle">
        ...
        <a href="{{ $baseUrl }}" style="display:block;text-align:center;margin-top:14px;font-size:.8rem;color:var(--gray-color);text-decoration:none;">
            ← Back to Home
        </a>
    </div>
</div>
...
document.getElementById('careerForm').addEventListener('submit', async function(e) {
    ...
    try {
        var res    = await fetch(@json(route('api.submit-application')), { method:'POST', body: new FormData(this) });
