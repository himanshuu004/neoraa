...
<head>
    ...
    <title>Manage Reviews - {{ $siteName }}</title>
...
<body>
        ...
        <div class="container-fluid p-4">
            ...
            <div class="nd-sheet-card">
                <div class="card-body p-0">
                    <div id="reviewsAlert" class="alert d-none m-3"></div>
                    ...
                    <div id="reviewsList" class="d-none">
                        <div class="nd-sheet-wrap">
                            <table class="table nd-sheet table-hover align-middle mb-0">
    ...
    <script>
        ...
        function loadReviews() {
            ...
            $.get('api/get-reviews', function(res) {
        ...
        $('#saveReviewBtn').on('click', function() {
            ...
            var url = id ? 'api/update-review' : 'api/create-review';
            if (id) data.id = id;
        ...
        $(document).on('click', '.delete-review', function() {
            ...
            $.post('api/delete-review', { id: id }).done(function(res) {
                if (res.success) {
