...
<head>
    ...
    <title>Trainee Dashboard - {{ $siteName }}</title>
...
<body>
    @include('trainee.partials.navbar')
    ...
    <script>
        ...
        $('#personalInfoForm').on('submit', function(e) {
            ...
            $.ajax({
                url: 'api/update-trainee-profile',
                method: 'POST',
                data: formData,
                dataType: 'json',
        ...
        function loadAttendanceRecords() {
            $.ajax({
                url: 'api/get-attendance-records',
                method: 'GET',
                dataType: 'json',
                success: function(response) {
                    if (response.success) {
