...
$navBase = defined('BASE_URL') ? BASE_URL : '/';
?>
                ...
                <ul class="d-flex flex-wrap list-unstyled m-0 align-items-center" style="gap:0 14px;">
                    ...
                    <li>
                        <a href="#" aria-label="Facebook">
                            <svg class="social" width="15" height="15"><use xlink:href="#facebook"></use></svg>
                        </a>
                    </li>
                    <li>
                        <a href="#" aria-label="YouTube">
                            <svg class="social" width="15" height="15"><use xlink:href="#youtube"></use></svg>
                        </a>
                    </li>
                </ul>
            </div>
    ...
    <nav id="primary-header" class="navbar navbar-expand-lg py-3">
        <div class="container-fluid padding-side">
            <div class="d-flex justify-content-between align-items-center w-100">
                ...
                <!-- Logo -->
                <a class="navbar-brand" href="<?php echo htmlspecialchars($navBase); ?>">
                    <img
                        src="<?php echo htmlspecialchars($navBase); ?>public/landing/logo/logo.webp"
                        alt="NEORA Logo"
                ...
                <a
                    href="<?php echo htmlspecialchars($navBase . 'login.php'); ?>"
                ...
                <div class="header-bottom offcanvas offcanvas-end" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                    <div class="offcanvas-header px-4 pb-0">
                        <img src="<?php echo htmlspecialchars($navBase); ?>public/landing/logo/logo.webp" alt="NEORA" style="height:40px;">
                    ...
                    <div class="offcanvas-body align-items-center justify-content-center">
                        <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                            <li class="nav-item px-3">
                                <a class="nav-link p-0 <?php echo basename($_SERVER['PHP_SELF']) === 'index.php' ? 'active' : ''; ?>" href="<?php echo htmlspecialchars($navBase); ?>">Home</a>
                            </li>
                            <li class="nav-item px-3">
                                <a class="nav-link p-0 <?php echo basename($_SERVER['PHP_SELF']) === 'about.php' ? 'active' : ''; ?>" href="<?php echo htmlspecialchars($navBase . 'about.php'); ?>">About</a>
                            </li>
                            <li class="nav-item px-3">
                                <a class="nav-link p-0 <?php echo basename($_SERVER['PHP_SELF']) === 'services.php' ? 'active' : ''; ?>" href="<?php echo htmlspecialchars($navBase . 'services.php'); ?>">Services</a>
                            </li>
                            <li class="nav-item px-3">
                                <a class="nav-link p-0 <?php echo basename($_SERVER['PHP_SELF']) === 'gallery.php' ? 'active' : ''; ?>" href="<?php echo htmlspecialchars($navBase . 'gallery.php'); ?>">Gallery</a>
                            </li>
                            <li class="nav-item px-3">
                                <a class="nav-link p-0 <?php echo basename($_SERVER['PHP_SELF']) === 'testimonials.php' ? 'active' : ''; ?>" href="<?php echo htmlspecialchars($navBase . 'testimonials.php'); ?>">Testimonials</a>
                            </li>
                            <li class="nav-item px-3">
                                <a class="nav-link p-0 <?php echo basename($_SERVER['PHP_SELF']) === 'contact.php' ? 'active' : ''; ?>" href="<?php echo htmlspecialchars($navBase . 'contact.php'); ?>">Contact</a>
                            </li>
                            <li class="nav-item px-3">
                                <a class="nav-link p-0 <?php echo basename($_SERVER['PHP_SELF']) === 'careers.php' ? 'active' : ''; ?>" href="<?php echo htmlspecialchars($navBase . 'careers.php'); ?>">Careers</a>
                            </li>
                        </ul>
                        <!-- Mobile Book Session -->
                        <div class="d-flex d-lg-none justify-content-center mt-4 px-3">
                            <a href="<?php echo htmlspecialchars($navBase . 'contact.php'); ?>" class="nd-btn-pill-nav">Book Session</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-none d-lg-flex align-items-center gap-3">
                    ...
                    <a href="<?php echo htmlspecialchars($navBase . 'login.php'); ?>" style="font-size:.85rem;font-weight:600;color:#555;white-space:nowrap;">Sign In</a>
                    <a href="<?php echo htmlspecialchars($navBase . 'contact.php'); ?>" class="nd-btn-pill-nav">Book Session</a>
                </div>
