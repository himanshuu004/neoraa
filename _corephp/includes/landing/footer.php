...
$footerBase = defined('BASE_URL') ? BASE_URL : '/';
?>
...
<section id="footer-section" data-aos="fade-up">
    <div class="footer-inner">
        <div class="footer-grid">
            ...
            <div>
                <a href="<?php echo htmlspecialchars($footerBase); ?>">
                    <img
                        src="<?php echo htmlspecialchars($footerBase); ?>public/landing/logo/logo.webp"
                        alt="NEORA Logo"
                ...
                <div class="footer-social">
                    ...
                    <a href="#" class="footer-social-link" aria-label="YouTube">
                        <svg width="16" height="16" fill="currentColor" viewBox="0 0 32 32">
                            <path d="M29.41 9.26a3.5 3.5 0 0 0-2.47-2.47C24.76 6.2 16 6.2 16 6.2s-8.76 0-10.94.59a3.5 3.5 0 0 0-2.47 2.47A36.13 36.13 0 0 0 2 16a36.13 36.13 0 0 0 .59 6.74a3.5 3.5 0 0 0 2.47 2.47c2.18.59 10.94.59 10.94.59s8.76 0 10.94-.59a3.5 3.5 0 0 0 2.47-2.47A36.13 36.13 0 0 0 30 16a36.13 36.13 0 0 0-.59-6.74ZM13.2 20.2v-8.4l7.27 4.2Z"/>
                        </svg>
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="footer-links">
                    <li><a href="<?php echo htmlspecialchars($footerBase); ?>">Home</a></li>
                    <li><a href="#about">About Us</a></li>
                    <li><a href="#services">Our Services</a></li>
                    <li><a href="<?php echo htmlspecialchars($footerBase . 'gallery.php'); ?>">Gallery</a></li>
                    <li><a href="#testimonials">Testimonials</a></li>
                    <li><a href="#contact">Contact Us</a></li>
                    <li><a href="<?php echo htmlspecialchars($footerBase . 'login.php'); ?>">Sign In</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <a href="<?php echo htmlspecialchars($footerBase . 'contact.php#book'); ?>" class="btn btn-arrow btn-primary">
