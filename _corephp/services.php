...
<div class="nd-page-hero" data-aos="fade-in">
    <div class="nd-page-hero-bg" style="background-image:url('public/landing/images/2296b393-0309-42ba-b6cc-405569f55368.JPG');"></div>
        ...
        <div class="nd-feature-strip" data-aos="fade-up" data-aos-delay="100">
            <?php foreach ($infographic_services as $s): ?>
                <div class="nd-feature-col <?php echo $s['col']; ?>">
                    ...
                    <a href="<?php echo BASE_URL; ?>contact.php" class="nd-feature-link">Book a Session</a>
                </div>
            <?php endforeach; ?>
        </div>
    </div>
