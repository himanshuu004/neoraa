...
<div class="nd-page-hero" data-aos="fade-in">
    <div class="nd-page-hero-bg" style="background-image:url('public/landing/images/494bd119-204d-4c5f-9b19-29fb0ae98677.JPG');background-position:center 25%;"></div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (reviewForm) {
        reviewForm.addEventListener('submit', async function (e) {
            ...
            try {
                var response = await fetch('<?php echo BASE_URL; ?>api/submit_review.php', {
