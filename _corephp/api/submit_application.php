...
try {
    ...
    if ($resume_path     && file_exists(__DIR__ . '/../' . $resume_path))     @unlink(__DIR__ . '/../' . $resume_path);
    if ($certificate_path && file_exists(__DIR__ . '/../' . $certificate_path)) @unlink(__DIR__ . '/../' . $certificate_path);
