...
<nav class="navbar sticky-top" style="z-index: 1000;">
    <div class="container-fluid px-3 px-md-4 d-flex align-items-center justify-content-between" style="min-height:64px;">
        ...
        <!-- Logo -->
        <a class="navbar-brand d-flex align-items-center gap-2 text-decoration-none" href="<?php echo BASE_URL; ?>trainee/dashboard.php">
            ...
            <div class="d-none d-sm-block" style="line-height:1.2;">
                ...
                <div style="font-size:0.65rem;color:#df5589;font-weight:500;text-transform:uppercase;letter-spacing:1.5px;">Trainee Portal</div>
            </div>
        </a>
        ...
        <div class="d-flex align-items-center gap-2 gap-md-3">
            ...
            <span class="d-none d-sm-inline-flex align-items-center px-2 py-1 rounded-pill"
                  style="background:rgba(161,196,74,0.12);color:#7a9e1a;font-size:0.65rem;font-weight:600;text-transform:uppercase;letter-spacing:1px;">
                Trainee
            </span>
    ...
    <div id="menuOverlay" class="menu-overlay" style="display:none;">
        <div class="menu-overlay-content">
            ...
            <div class="menu-drawer-body">
                <a href="<?php echo BASE_URL; ?>trainee/dashboard.php#personal" class="nav-link-overlay" onclick="closeMenuOverlay()">
                    <i class="fas fa-user me-3"></i>Personal Info
                </a>
                <a href="<?php echo BASE_URL; ?>trainee/dashboard.php#notices" class="nav-link-overlay" onclick="closeMenuOverlay()">
                    <i class="fas fa-bullhorn me-3"></i>Notices & Updates
                </a>
                <a href="<?php echo BASE_URL; ?>trainee/dashboard.php#attendance" class="nav-link-overlay" onclick="closeMenuOverlay()">
                    <i class="fas fa-check-circle me-3"></i>Attendance & Sessions
                </a>
