                ...
                <div class="content-section" id="personal">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-4 mb-4">
                                ...
                                if ($profileImage && file_exists('../' . $profileImage)) {
                                    echo '<img src="../' . htmlspecialchars($profileImage) . '" alt="Profile" class="rounded-circle" style="width:80px;height:80px;object-fit:cover;border:2px solid #df5589;">';
                                } else {
                    ...
                    <div class="card mt-3">
                        <div class="card-body text-center">
                            ...
                            <a href="<?php echo BASE_URL; ?>admin/application.php" class="btn btn-primary">
